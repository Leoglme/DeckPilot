...
/**
 * Type-checks the app against types generated in a dedicated build dir, so the gate never
 * fights the `.nuxt` owned by a running dev server (regenerating it would break its Vite
 * manifest). Mirrors the DevLeadHunter tooling.
 */
