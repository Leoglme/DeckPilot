...
export default withNuxt(
  ...
  {
    // Pinia option stores: the `defineStore` export type is inferred, not worth annotating by hand.
    files: ['app/stores/**/*.ts'],
    rules: {
      '@typescript-eslint/typedef': [
        'error',
  ...
  {
    // Tooling scripts in JavaScript: a type annotation there is a syntax error.
    files: ['**/*.mjs', '**/*.js'],
    rules: {
